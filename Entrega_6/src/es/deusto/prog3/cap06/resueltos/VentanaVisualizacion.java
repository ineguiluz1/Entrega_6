...
public class VentanaVisualizacion extends JFrame {
		...
		arbol.addTreeSelectionListener(new TreeSelectionListener() {
			...
			public void valueChanged(TreeSelectionEvent e) {
			    ...
			    if (camino.getPathCount() == 3) {
			        Object selectedNode = arbol.getLastSelectedPathComponent();
			        if (selectedNode instanceof DefaultMutableTreeNode) {
			            DefaultMutableTreeNode node = (DefaultMutableTreeNode) selectedNode;
			            Object prov = node.getUserObject(); // Obtenemos el objeto asociado al nodo
			            if (prov != null && prov instanceof String) {
	...
	public void crearDatosDeTabla( String provincia ) {
		...
		for( String s: municipios) {
			...
			Object[] datoTabla = new Object[] {mun.getCodigo(), mun.getNombre(), mun.getHabitantes(),mun.getProvincia() };
